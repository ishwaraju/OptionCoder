...
class MainConfig:
    ...
    HIGH_PROB_ACTION_ONLY = os.getenv('HIGH_PROB_ACTION_ONLY', 'True').lower() == 'true'
    HIGH_PROB_MIN_CONTEXT_SCORE = float(os.getenv('HIGH_PROB_MIN_CONTEXT_SCORE', '88.0'))
    HIGH_PROB_MIN_ENTRY_SCORE = float(os.getenv('HIGH_PROB_MIN_ENTRY_SCORE', '86.0'))
    HIGH_PROB_MIN_PRO_SCORE = float(os.getenv('HIGH_PROB_MIN_PRO_SCORE', '75.0'))
    HIGH_PROB_REQUIRE_PREMIUM_CONFIRMED = os.getenv('HIGH_PROB_REQUIRE_PREMIUM_CONFIRMED', 'True').lower() == 'true'
    ...
    OPTION_CHAIN_MIN_INTERVAL_SECONDS = float(os.getenv('OPTION_CHAIN_MIN_INTERVAL_SECONDS', '3.1'))
    ...
    NO_CHASE_PULLBACK_WATCH_ENABLED = os.getenv('NO_CHASE_PULLBACK_WATCH_ENABLED', 'True').lower() == 'true'
    PREMIUM_PULLBACK_ENTRY_RETRACE_PCT = float(os.getenv('PREMIUM_PULLBACK_ENTRY_RETRACE_PCT', '8.0'))
    PREMIUM_LEADER_VOLUME_DELTA_DIVISOR = float(os.getenv('PREMIUM_LEADER_VOLUME_DELTA_DIVISOR', '50000.0'))
    ...
    ICT_FVG_ENABLED = os.getenv('ICT_FVG_ENABLED', 'True').lower() == 'true'
    ICT_FVG_MAX_AGE_BARS = int(os.getenv('ICT_FVG_MAX_AGE_BARS', '8'))
    ICT_FVG_MIN_CONTEXT_SCORE = float(os.getenv('ICT_FVG_MIN_CONTEXT_SCORE', '76'))
    ICT_FVG_MIN_ENTRY_SCORE = float(os.getenv('ICT_FVG_MIN_ENTRY_SCORE', '66'))
    ...
    ENABLE_DATA_HEALTH_TELEGRAM_ALERTS = os.getenv('ENABLE_DATA_HEALTH_TELEGRAM_ALERTS', 'False').lower() == 'true'
    DATA_HEALTH_ALERT_COOLDOWN_SECONDS = int(os.getenv('DATA_HEALTH_ALERT_COOLDOWN_SECONDS', '900'))
    ENABLE_STARTER_ENTRY = os.getenv('ENABLE_STARTER_ENTRY', 'True').lower() == 'true'
    STARTER_ENTRY_MIN_CONTEXT_SCORE = float(os.getenv('STARTER_ENTRY_MIN_CONTEXT_SCORE', '84'))
    STARTER_ENTRY_MIN_ENTRY_SCORE = float(os.getenv('STARTER_ENTRY_MIN_ENTRY_SCORE', '78'))
    FAST_SPIKE_ACTION_MIN_CONTEXT_SCORE = float(os.getenv('FAST_SPIKE_ACTION_MIN_CONTEXT_SCORE', '84'))
    FAST_SPIKE_ACTION_MIN_ENTRY_SCORE = float(os.getenv('FAST_SPIKE_ACTION_MIN_ENTRY_SCORE', '78'))
    ...
    # SHUTDOWN SETTINGS
    # ==============================
    BOT_SHUTDOWN_TIME = os.getenv('BOT_SHUTDOWN_TIME', '15:31')
