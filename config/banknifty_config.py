...
class BankNiftyConfig:
    ...
    STOP_LOSS_PERCENT = float(os.getenv('BANKNIFTY_STOP_LOSS_PERCENT', '15.0'))
    TARGET_PERCENT = float(os.getenv('BANKNIFTY_TARGET_PERCENT', '20.0'))
    TRAIL_PERCENT = float(os.getenv('BANKNIFTY_TRAIL_PERCENT', '10.0'))
    ...
    OPTION_CACHE_MAX_AGE_SECONDS = int(os.getenv('BANKNIFTY_OPTION_CACHE_MAX_AGE_SECONDS', '60'))
